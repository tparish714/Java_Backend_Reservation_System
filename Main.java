...
public class Main
{
            ...
            else
            {
                ...
                do
                {
                    ...
                    switch(userInput)
                    {
                        ...
                        case 2: // view
                            displayOrders(orderList, 2);
                            break;

                        case 3: // update
                            displayOrders(orderList, 3);
                            int orderNo=0;
    ...
    public static void displayOrders(LinkedList<orders> list, int menu)
    {
        System.out.println();
        // print all the orders
        for (int i = 0; i < list.size(); i++)
        {
            if (menu==3) // update: display the orders in a numerical menu system
